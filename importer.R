...
do_magic <- function() {
  ...
  COM_ALLERGY=read.csv("COM_ALLERGY.csv", header=TRUE, sep=";")
  MED_VAX=read.csv("MED_VAX.csv", header=TRUE, sep=";")
  PRIOR_COVID=read.csv("PRIOR_COVID.csv", header=TRUE, sep=";")
  V_DAY=read.csv("V_DAY.csv", header=TRUE, sep=";")
  BLOOD=read.csv("BLOOD.csv", header=TRUE, sep=";")
  TC_VAX=read.csv("TC_VAX.csv", header=TRUE, sep=";")
  FU_1M=read.csv("FU_1M.csv", header=TRUE, sep=";")
  TC_18M=read.csv("TC_18M.csv", header=TRUE, sep=";")
  MEDICATIONS=read.csv("MEDICATIONS.csv", header=TRUE, sep=";")
  COVID=read.csv("COVID.csv", header=TRUE, sep=";")
  ADV_EV=read.csv("ADV_EV.csv", header=TRUE, sep=";")
